...
<div class="wrap">
    ...
    <div class="card">
        ...
        <div class="upload-area" onclick="document.getElementById('file-input').click()">
            ...
            <p>点击上传简历附件（PDF/Word）</p>
            <p style="font-size:11px;color:#bbb;margin-top:4px">支持 PDF、DOC、DOCX，最大 10MB</p>
        </div>
        <input type="file" id="file-input" style="display:none" accept=".pdf,.doc,.docx" onchange="uploadFile(this)">
...
function uploadFile(input) {
    ...
    div.innerHTML = '📄 ' + file.name + ' <span style="color:#888;font-size:12px">(' + (file.size/1024).toFixed(0) + 'KB)</span> <span style="color:#27ae60;margin-left:8px">✓ 已上传</span>';
